...
import HauntedHouse.Tokenizer.Data ( Lexeme(PLANT, SMALL, POT) )
import HauntedHouse.Game.Actions.Look.PlantPot ( firstLook, lookOn)
...
standardActions = StandardActions
  ...
  , _put' = const pass
  , _lookIn' = const firstLook
  , _lookAt' = const (firstLook >>  lookOn)
  , _lookOn' = const lookOn -- ToDo
  }
